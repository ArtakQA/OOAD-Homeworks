public class Controller {
    public static void main(String[] args) {
        ...
        testing.testToInt();
        testing.negativeTestInt();
        testing.testDoubleInt();
        testing.testToIntZero();
        testing.testToDoubleMinus();
        testing.testDouble();
        testing.testReset();
        SpreadSheet sp = new SpreadSheet(5, 4);
        sp.setNewSheet(0,0, "test5");
        sp.setNewSheet(0,1,"1");
        sp.setNewSheet(0,2,"2");
        sp.setNewSheet(0,3,"3");
        sp.setNewSheet(1,0,"test4");
        sp.setNewSheet(1,1,"1");
        sp.setNewSheet(1,2,"2");
        sp.setNewSheet(1,3,"3");
